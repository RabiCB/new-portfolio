...
const Intervalform = ({message,setInput,input,setSendmessage ,setEmail,Email,hanldeSubmit,error}) => {
  return (
    <>
    
          <div className=" flex items-center bg-opacity-80 justify-center rounded-lg bg-[#171515] z-40 absolute top-0 left-0 bottom-0 right-0 flex-col gap-4 ">
            ...
            <motion.form
              ...
              action="https://getform.io/f/5ac02887-3188-41de-8f0e-a7b168b73f7f" method="POST"
            ...
            >
              ...
              <button type="submit" onClick={hanldeSubmit} className="bg-blue-500 text-white rounded-lg cursor-pointer flex items-center justify-center gap-2 h-[40px]">
                Submit{" "}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
